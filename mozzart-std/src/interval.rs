...
/// # Examples
/// ```
/// use mozzart_std::{Step, Interval};
/// use mozzart_std::constants::*;
///
/// let step = WHOLE_AND_HALF;
...
/// Conversion from a reference to `Step` to `Interval`
///
/// This allows converting a step to an interval without consuming it.
///
/// # Examples
/// ```
/// use mozzart_std::{Step, Interval};
