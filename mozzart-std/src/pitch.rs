...
use crate::{harmonic_scale, major_scale, melodic_scale, minor_scale, Interval, Scale};
use std::{
    fmt::Debug,
...
impl Pitch {
    ...
    /// assert_eq!(c_harmonic.steps(), [TONE, SEMITONE, TONE, TONE, SEMITONE, MINOR_THIRD, SEMITONE]);
    /// ```
    ///
    /// # Panics
    ///
    ...
    /// assert_eq!(c_melodic.steps(), [TONE, SEMITONE, TONE, TONE, TONE, TONE, SEMITONE]);
    /// ```
    ///
    /// # Panics
    ///
